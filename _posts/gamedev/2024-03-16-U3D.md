...
1. 有碰撞体积的障碍物Prefab， 向player方向translate
...
7. SpawnManager 在固定位置生成障碍物prefab， 记得将控制prefab向左translate的脚本override

8. extract生成障碍物方法并InvokeRepeating 调用
...
9.  在player刚体组件中，展开constraints，然后冻结除Y position以外的所有
