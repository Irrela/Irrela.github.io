...
struct BoardView: View {
    var body: some View {
        Text("Hello, World!".uppercased()) // 调整大小写，.lowercased(), capitalized
            .font(.title)
            .fontWeight(.semibold)
            .bold()
            .underline()
            ...
            .baselineOffset(10.0) // 行间距，负值代表上下padding
            .kerning(1.0) // 字母间距：pixel
            .multilineTextAlignment(.leading) // 多行文本对齐方式

            .frame(width: 200, height:100, alignment: .center) // 文本区域
